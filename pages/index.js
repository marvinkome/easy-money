...
import { chakra, Container, Heading, Text, Stack, Button, Image, Icon, IconButton, Input, Center, Wrap } from "@chakra-ui/react";
      ...
      <Container maxW="container.xl">
        ...
        >
          <Stack py={4} justify="end" alignItems="center" spacing={2} direction="row">
            <IconButton rounded="full" size="lg" fontSize="2xl" variant="ghost" icon={<BsTwitter />} />
            <IconButton rounded="full" size="lg" fontSize="2xl" variant="ghost" icon={<FaDiscord />} />
          </Stack>
          ...
          <Stack mt={8} spacing={{ base: 4, md: 16 }} px={{ base: 4, md: 0 }}>
            ...
            <Stack spacing={10} maxW="md">
              ...
              <chakra.div textAlign={{ base: "center", md: "unset" }}>
                <Button _active={{ opacity: 0.8 }} _hover={{ opacity: 0.8 }} color="black" bgColor="#D9D9D9" px={8} rounded="full">
                  JOIN OUR DISCORD
                </Button>
              </chakra.div>
            </Stack>
        ...
        <chakra.section id="nfts" my={{ base: 24, md: 40 }}>
          ...
          <chakra.div maxW="md" mt={{ base: 12, md: 16 }} mx="auto" textAlign="center">
            ...
            <Button mt={6} _active={{ opacity: 0.8 }} _hover={{ opacity: 0.8 }} color="black" bgColor="#D9D9D9" px={8} rounded="full">
              JOIN DISCORD
            </Button>
          </chakra.div>
        </chakra.section>
        ...
        <chakra.section id="video" my={{ base: 24, md: 40 }} textAlign="center">
          <Image mx="auto" width={{ lg: "50rem", base: "40rem" }} src="/images/snapshot.png" alt="" />
        </chakra.section>
        ...
        <chakra.section id="faq" my={{ base: 24, md: 40 }}>
          ...
          <chakra.div mt={16} textAlign="center">
            <Button width="13rem" rounded="full" colorScheme="twitter" leftIcon={<BsTwitter />}>
              Share on Twitter
            </Button>
          </chakra.div>
        </chakra.section>
        ...
        <chakra.footer my={{ base: 12, md: 20 }} maxW="xl" mx="auto">
          ...
          <Stack mt={12} direction="row" justifyContent="center" spacing={4}>
            <IconButton rounded="full" size="lg" fontSize="3xl" variant="ghost" icon={<BsTwitter />} />
            <IconButton rounded="full" size="lg" fontSize="3xl" variant="ghost" icon={<FaDiscord />} />
          </Stack>
        </chakra.footer>
      </Container>
    </>
